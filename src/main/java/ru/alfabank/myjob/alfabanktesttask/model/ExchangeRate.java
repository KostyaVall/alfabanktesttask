...
public class ExchangeRate {
    ...
    public ExchangeRate(String disclaimer, String license, String base, Map<String, Double> rates) {
    ...
    public boolean equals(Object o) {
        ...
        ExchangeRate exchange = (ExchangeRate) o;
        ...
        if (getBase() != null ? !getBase().equals(exchange.getBase()) : exchange.getBase() != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 23 * result + (getLicense() != null ? getLicense().hashCode() : 0);
        result = 23 * result + (getBase() != null ? getBase().hashCode() : 0);
        result = 23 * result + (getRates() != null ? getRates().hashCode() : 0);
